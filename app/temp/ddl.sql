...
-- 스토리사진
ALTER TABLE TABLE3
    ADD CONSTRAINT PK_TABLE3 -- 스토리사진 기본키
    PRIMARY KEY (
    photo_id, -- 사진번호
    story_id  -- 스토리번호
    );
...
CREATE TABLE TABLE7 (
    ...
    story_id INTEGER NULL COMMENT '스토리번호' -- 스토리번호
)
COMMENT '좋아요';
...
-- 스토리사진
ALTER TABLE TABLE3
    ADD CONSTRAINT FK_story_TO_TABLE3 -- 스토리 -> 스토리사진
    FOREIGN KEY (
    story_id -- 스토리번호
    )
    REFERENCES story ( -- 스토리
...
-- 스토리사진
ALTER TABLE TABLE3
    ADD CONSTRAINT FK_story_photo_TO_TABLE3 -- 스토리사진 -> 스토리사진
    FOREIGN KEY (
    photo_id -- 사진번호
    )
    REFERENCES story_photo ( -- 스토리사진
    photo_id -- 사진번호
    );
...
-- 좋아요
ALTER TABLE TABLE7
    ADD CONSTRAINT FK_user_TO_TABLE7 -- 회원 -> 좋아요
    FOREIGN KEY (
    user_id -- 회원번호
    )
    REFERENCES user ( -- 회원
...
-- 좋아요
ALTER TABLE TABLE7
    ADD CONSTRAINT FK_story_TO_TABLE7 -- 스토리 -> 좋아요
    FOREIGN KEY (
    story_id -- 스토리번호
    )
    REFERENCES story ( -- 스토리
